...
<body>
    ...
    <main style="margin-top: 40px" class="container table-responsive">
      <h1 class="text-center mb-10"><strong>Pendientes de presupuesto</strong></h1>
            ...
            <tbody>
                @foreach ($equipos as $equipo)
                  <tr>
                    ...
                    <td><a class="btn btn-outline-primary" href="{{ route('equipos.showequipo', ['id' => $equipo->id]) }}">Abrir</a></td>
